                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-12 mx-auto">
                            <form class="custom-form login-form" role="form" method="post" action = "./DeleteRobotInfo">
                                <h2 class="hero-title text-center mb-4 pb-2">Delete Robot</h2>
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-lg-10 col-12">
                                        <button type="submit" class="form-control" name="delete">Delete</button>
                                    </div>
                                </div>
