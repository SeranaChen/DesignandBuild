                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
							...
							<form class="custom-form login-form text-center" role="form" method="post" action="./searchRobotInfo">
								<span class="text-white">username：</span>  <input type="text" name="username"/><br/><br/>
