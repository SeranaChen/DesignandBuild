                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            <form class="custom-form" role="form" method="post" action="./BackToHomePage">
                                <h2 class="hero-title text-center mb-4 pb-2">Information update successfully.</h2>
                                <div class="col-lg-5 col-12">
                                        <button type="submit" class="form-control">Back to home page</button>
                                </div>
                            </form>
                        </div>
                    </div>
